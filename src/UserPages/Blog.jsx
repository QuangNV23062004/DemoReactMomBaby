...
export default function Blog() {
  ...
  const fetchBlogPosts = async () => {
    try {
      const response = await fetch(
        "https://667f687ff2cb59c38dc8cee6.mockapi.io/api/v1/Blog"
      );
      if (!response.ok) {
  ...
  return (
    <div>
      <nav
        className="navbar navbar-expand-lg navbar-dark ftco_navbar bg-white ftco-navbar-light"
        id="ftco-navbar"
      >
        <div className="container">
          <Link
            style={{ color: "#ff469e", fontSize: "28px" }}
          ...
          <div className="collapse navbar-collapse" id="ftco-nav">
            <ul className="navbar-nav ml-auto">
              <li className="nav-item">
                <Link to="/SWP391-MomAndBaby" className="nav-link">
                  Home
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/SWP391-MomAndBaby/blog" className="nav-link">
                  Blog
                </Link>
              </li>
            </ul>
        ...
        <div className="container">
          <div className="row no-gutters slider-text align-items-center justify-content-center">
            ...
            >
              ...
              <h1 style={{ fontSize: "60px" }} className="mb-0 bread">
                Blog
              </h1>
            </div>
          </div>
      ...
      <div className="container mt-4">
        ...
        <Pagination>
          ...
          />
          <Pagination.Last
            onClick={() => paginate(Math.ceil(blogPosts.length / postsPerPage))}
          />
        </Pagination>
      </div>
